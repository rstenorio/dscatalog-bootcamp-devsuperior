...
public class ProductResourceTests {
	...
	public void deleteShouldDoNothingWhenIdExists() throws Exception {
		...
		String accessToken = tokenUtil.obtainAccessToken(mockMcv, userName, password);

		ResultActions res = mockMcv
				.perform(delete("/products/{id}", idExisting)
	...
	public void insertShouldReturnProduct() throws Exception {
		...
		ResultActions res = mockMcv.perform(post("/products/", dto).content(jsonBody)
	...
	public void updateShouldReturnProductWhenIdexists() throws Exception {
		...
		ResultActions res = mockMcv.perform(put("/products/{id}", idExisting).content(jsonBody)
				.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)
				.header("Authorization", "Bearer" + accessToken));
	...
	public void updateShouldReturnNotFoundWhenIdNonexists() throws Exception {
		...
		ResultActions res = mockMcv.perform(put("/products/{id}", idNonExisting).content(jsonBody)
				.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)
				.header("Authorization", "Bearer" + accessToken));
	...
	public void findAllShouldReturnPage() throws Exception {
		ResultActions res = mockMcv.perform(get("/products").accept(MediaType.APPLICATION_JSON));
	...
	public void findByIdShouldReturnProductWhenIdExists() throws Exception {
		ResultActions res = mockMcv.perform(get("/products/{id}", idExisting).accept(MediaType.APPLICATION_JSON));
		res.andExpect(status().isOk());
		res.andExpect(jsonPath("$.id").exists());
	}
	...
	public void findByIdShouldReturnNotFoundWhenIdNonExists() throws Exception {
		ResultActions res = mockMcv.perform(get("/products/{id}", idNonExisting).accept(MediaType.APPLICATION_JSON));
